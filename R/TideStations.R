#' @title Retrive unique station code from station name
#'
#' @description Inspects harmonics data for stations with similar names to the \code{station}
#'   parameter. Users can enter either an exact name, or the first few letters. If an exact,
#'   unique match is not found, it will print a list of possible matches.
#'
...
#' @title Retrieve information for the selected tide station
#'
#' @description Retrieves tide station information such as timezone, and station type.
#'   If the station type is a subordinate station it will also retrieve the \code{station_code}
#'   for the harmonic reference station.
#'
...
#' @title Generate a vector of datetime values from \code{start_date} to \code{end_date}
#'
#' @description Generates a vector of datetime values over the requested time span for tide
#'   predictions. Values are output in timezone UTC.
#'
